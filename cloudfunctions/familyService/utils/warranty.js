...
/**
 * Calculate years addition with proper leap year handling
 */
function addYears(dateStr, years) {
  ...
  // Handle leap year Feb 29 overflow by rolling back to last day of month
  if (d.getDate() !== originalDay) {
    d.setDate(0)
  }
...
module.exports = {
  ...
  getWarrantyYears,
  calcWarrantyEnd,
  addYears  // Export for cloud function reuse
}
